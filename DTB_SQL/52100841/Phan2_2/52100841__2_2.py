...
print("Nhập tập thuộc tính X cần bao đóng ( cú pháp mỗi thuộc tính cách nhau bởi một giấu cách, tập thuộc tính X xem trong file input: )")
baoDong1 = input()
...
baoDongFile = baoDongFile + "\n" + "Lược đồ chỉ có một khóa duy nhất là: \n"
