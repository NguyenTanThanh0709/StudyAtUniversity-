<?php
    ...
    // $sql = "SELECT COUNT(*) FROM account WHERE user ='...' and password = '...'";
    ...
    if (isset($_POST['user']) && isset($_POST['pass'])) {
        ...
        $sql = "SELECT COUNT(*) AS `count`, lastname FROM `account` where `username` = '$user' AND `password` = '$pass'";
        ...
        if (empty($user)) {
            ...
            $_SESSION['user'] = 'admin';
            $_SESSION['name'] = 'Nguyen Tan Thanh';
